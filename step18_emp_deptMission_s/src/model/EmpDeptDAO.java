...
public class EmpDeptDAO {
	...
	//생략시엔 class 선언구에 적용된 access modifier 가 적용된 public EmpDeptDAO() {} 생성
	private EmpDeptDAO() {}
	...
	public Dept findDept(long deptno) throws Exception{
		...
		try {
			 dept = em.find(Dept.class, deptno);  // em.find(Dept.class, new Long(deptno)) 으로 변환
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
		} finally {
	...
	/* Dept 객체의 deptno만 뽑아서 emp table의 deptno에 insert 	 */
	...
	//TO DO  dao.updateEmployee(1201L, 46000L);
